...
public interface Transport {
     ...
     * 
     * @param container The container to which incoming requests should be provided
     */
    public void setServiceContainer(ServiceContainer container);

    /**
     * Starts this <code>Transport</code>. Once a <code>Transport</code> has been started, it may begin submitting
     * <code>Request</code>s to its associated <code>ServiceContainer</code>
     * 
    ...
    /**
     * Stops this <code>Transport</code>. No further requests should be sent to the transports associated
