...
public interface MutableCookie extends Cookie {
    ...
    /**
     * Mark the cookie a only for HTTP. Browser are supposed to block access to this cookie from client side code.
    ...
    /**
     * Sets the date the cookie was created. This value is never sent over HTTP but is used by clients to calculate the
