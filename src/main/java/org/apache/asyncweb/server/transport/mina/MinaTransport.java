...
/**
 * A <code>Transport</code> implementation which receives requests and sends responses using non-blocking selector based
 * IO.
 * 
...
public class MinaTransport implements Transport {
     ...
     * 
     * @param address The address to bind to. Specify <tt>null</tt> or <tt>"*"</tt> to listen to all NICs (Network
     *            Interface Cards).
     */
    ...
    /**
     * Sets the number of worker threads employed by this transport. This should typically be a small number (2 is a
     * good choice) - and is not tied to the number of concurrent connections you wish to support
     * 
    ...
    /**
     * Sets whether traffic received through this transport is logged (off by default)
     * 
    ...
    /**
     * Initializes our handler - creating a new (default) handler if none has been specified
     * 
     * @throws IllegalStateException If we have not yet been associated with a container
     */
