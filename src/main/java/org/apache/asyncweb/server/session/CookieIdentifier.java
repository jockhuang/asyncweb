...
/**
 * A <code>SessionIdentifier</code> which adds and extracts session key cookies
 * 
 * 
 */
public class CookieIdentifier implements HttpSessionIdentifier {
    ...
    /**
     * Sets the name of the cookie used for holding session keys. The default cookie name is <code>sessionKey</code>
     * 
    ...
    /**
     * Extracts a session key from the session cookie supplied with the request - if any
     * 
