...
public class CounterKeepAliveStrategy extends BasicKeepAliveStrategy {
    ...
    /**
     * @param maxKeepAlives The maximum number of requests for which a connection should be kept alive
     */
    ...
    /**
     * Determines whether a connection should be "kept alive" based on the number of requests for which the connection
     * has previously been kept alive.
     * 
