...
public class DefaultDirectoryIndexGenerator implements DirectoryIndexGenerator {
    ...
    public IoBuffer generateIndex(File directory) {
        if (bundle == null) {
            ...
            bundle = ResourceBundle.getBundle(DefaultDirectoryIndexGenerator.class.getPackage().getName() + ".strings");
        }
        ...
        html.append(bundle.getString("lastModifiedHeader")).append("</th></tr>\n");

        // back to parent directory
        html.append("<tr><td><a href=\"..\">").append(bundle.getString("parentDirectory"));
