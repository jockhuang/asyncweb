...
public interface HttpServiceFilter {
     ...
     * 
     * This handler should call <code>invokeNext</code> when it has completed its duties. This invocation may occur
     * asyncronously - but <i>must</i> occur for each notification
     * 
