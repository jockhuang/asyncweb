...
public class HttpResponseStatus implements Serializable {
    ...
    public static final HttpResponseStatus CONTINUE = new HttpResponseStatus(100, "Continue", false, false, false);
    ...
    private HttpResponseStatus(int code, String description, boolean allowsMessageBody,
            boolean forcesConnectionClosure, boolean finalResponse) {
