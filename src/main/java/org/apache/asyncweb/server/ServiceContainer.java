...
public interface ServiceContainer {
    ...
    /**
     * Adds a {@link HttpServiceFilter} to this container. Requests dispatched to this container are run through filters
    ...
    /**
     * Adds a <code>Transport</code> to this container. The transport is provided with a <code></code>, and is started
    ...
    /**
     * Returns the employes {@link HttpSessionAccessor} to be supplied to each request as it passes through the
     * container. The accessor is shutdown when this container is stopped
     */
    HttpSessionAccessor getSessionAccessor();

    /**
     * Sets the <code>SessionAccessor</code> to be supplied to each request as it passes through the container. The
     * accessor is shutdown when this container is stopped
     * 
    ...
    /**
     * Starts this container. Requests may be dispatched to this container after it has been started. During start-up,
     * this container starts all associated transports and service handlers.
     * 
    ...
    /**
     * Stops this container. During shut-down, this container stops all associated transports and service handlers.
     */
    void stop();
}
