...
public class DefaultCookie implements MutableCookie {
     ...
     * 
     * @param cookie the <tt>Cookie</tt> object from which the new instance of <tt>DefaultCookie</tt> will copy its
     *            values
     */
    ...
    public String toString() {
        return "name=" + getName() + " value=" + getValue() + " domain=" + getDomain() + " path=" + getPath()
                + " maxAge=" + getMaxAge() + " secure=" + isSecure() + " httpOnly=" + isHttpOnly();
    }
}
