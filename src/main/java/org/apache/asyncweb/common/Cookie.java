...
public interface Cookie extends Serializable, Comparable<Cookie> {
    ...
    /**
     * Returns the date the cookie was create. This value is not included in the HTTP header. This is a convenience
     * method for clients to determine when the cookie will expire.
     * 
    ...
    /**
     * Returns the date the expiration date of the cookie. This value is calculated based on the the values returned by
     * {@link #getMaxAge()} and {@link #getCreatedDate()}.
     * 
    ...
    /**
     * Returns if this cookie is marked as "HTTP only". {@link http://www.owasp.org/index.php/HTTPOnly}
     */
    boolean isHttpOnly();
}
