...
/**
 * An HTTP client connection listener. Since Asyncweb allows asynchronous handling of responses (response need not be
 * committed in the HttpService handleRequest() method), connections can be held open for some time. For this reason a
 * mechanism is needed to be informed of client disconnects or for notifications when the connection idles.
 * 
