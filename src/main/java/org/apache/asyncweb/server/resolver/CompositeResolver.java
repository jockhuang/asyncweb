...
/**
 * A <code>ServiceResolver</code> which applies a list of child resolvers in turn until a match is made or all children
 * have been tried
 * 
 */
public class CompositeResolver implements ServiceResolver {
    ...
    /**
     * Requests all child resolvers to resolve the request until either a resolution is found, or all child resolvers
     * have been tried.
     * 
     * @param request The request to resolve
     * @return The service name, or <code>null</code> if no resolution could be found
     */
    ...
    /**
     * Adds a resolver. Resolvers are applied in the order they are added
     * 
