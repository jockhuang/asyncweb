...
/**
 * A strategy for encoding / decoding session keys information to / from requests.
 * 
 * 
 */
public interface HttpSessionIdentifier {
     ...
     * @return The extracted key, or <code>null</code> if the request does not contain a session key
     */
